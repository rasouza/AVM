...
//     };            
	...
	$('#email').blur(function(){             
		...
		if( !expr.test( $(this).val() ) )  
			addError('<p class="error">Email incorreto!</p>', this);            
		else 
			removeError(this);
	});
	...
	$('#form-contact .required').blur(function(){
		if( $(this).val() == '' )
			addError('<p class="error">Um ou mais campos est&atilde;o vazios!</p>', this);
		else               
			removeError(this);
	});
	...
	$('#form-contact').submit(function(){
		...
		{                                                
			...
			addError('<p class="error">Um ou mais campos n&atilde;o est&atilde;o preenchidos corretamente!</p>', this);
